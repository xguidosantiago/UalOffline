...
def printManual():
    ...
    print("Los cursos contienen la siguiente estructura de diccionario {id,nombre,fecha_inicio,fecha_fin,eliminado}. ")
    ...
    print("Además, tenemos un atributo ELIMINADO, el cual es un bool para validar que si el curso fue eliminado (1) no se muestre en la lista, ")
    ...
    print("en el listado de cursos activos. Tambien se validará a la hora de realizar inscripciones, si se ingresa el ID de un curso eliminado, nos dará error.")
    print("")
    print("Una vez que ingresamos al menu de Ver Cursos automaticamente nos traerá los cursos activos. debajo del listado podremos hacer 4 opciones: ")
    print("alta de curso, modificar curso, eliminar curso y volver. Tanto modificar curso como eliminar curso realizarán la validación con el ID del curso ")
    ...
    print("El diccionario de datos de las inscripciones es {idCurso,idAlumno}, el cual asocia el id de curso con el dni del alumno, como una tabla intermedia.")
    print("Al ingresar a las inscripciones, nos listará los cursos activos y automaticamente nos pedirá el ID del curso para ver las inscripciones actuales. ")
